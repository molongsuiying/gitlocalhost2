...
@TableName("app_accident")
public class AppAccident implements Serializable {
    ...
    /**成果类别*/
    @Dict(dicCode = "accident_type")
    private Integer accidentType;
    /**成果类别备注*/
    private String accidentTypeTxt;
    /**成果级别*/
    @Dict(dicCode = "accident_level")
    private Integer accidentLevel;
    /**成果级别备注*/
    private String accidentLevelTxt;
    /**作品名称*/
