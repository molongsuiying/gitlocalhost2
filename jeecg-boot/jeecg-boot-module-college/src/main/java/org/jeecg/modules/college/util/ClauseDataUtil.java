...
public class ClauseDataUtil {
	 ...
	 * @param permission
	 */
//	public static AppClause intelligentProcessData(AppClause permission) {
//		if (permission == null) {
//			return null;
//		}
//
...
//	}
	 ...
	 * @param metaList
	 */
	public static void addIndexPage(List<AppClause> metaList) {
		boolean hasIndexMenu = false;
		for (AppClause AppClause : metaList) {
			if("首页".equals(AppClause.getName())) {
				hasIndexMenu = true;
				break;
			}
		}
//		if(!hasIndexMenu) {
//			metaList.add(0,new AppClause(true));
//		}
	}
	 ...
	 * @return
	 */
	public static boolean hasIndexPage(List<AppClause> metaList){
		boolean hasIndexMenu = false;
		for (AppClause AppClause : metaList) {
			if("首页".equals(AppClause.getName())) {
				hasIndexMenu = true;
