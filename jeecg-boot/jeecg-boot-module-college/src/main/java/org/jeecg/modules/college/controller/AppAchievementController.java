...
public class AppAchievementController {
    ...
    @Resource
    private AppAchievementService fileService;
     ...
     * @return
     */
    @RequestMapping(value = "/queryAppAchievementList", method = RequestMethod.GET)
    public Result<IPage<AppAchievement>> queryAppAchievementList(@RequestParam(name="pageNo", defaultValue="1") Integer pageNo,
                                                         @RequestParam(name="pageSize", defaultValue="10") Integer pageSize, HttpServletRequest req) {
        Result<IPage<AppAchievement>> result = new Result<>();
        IPage<AppAchievement> page = new Page<>(pageNo, pageSize);
        ...
        List<AppAchievement> pageList = fileService.queryList(query);
    ...
    @RequestMapping(value = "/queryAppAchievementListByCreateBy", method = RequestMethod.GET)
    public Result<IPage<AppAchievement>> queryAppAchievementListByCreateBy(@RequestParam(name="pageNo", defaultValue="1") Integer pageNo,
                                                         @RequestParam(name="pageSize", defaultValue="10") Integer pageSize, HttpServletRequest req) {
        Result<IPage<AppAchievement>> result = new Result<>();
        IPage<AppAchievement> page = new Page<>(pageNo, pageSize);
        Map<String,Object> query = CollegeUtil.getParameterMap(req);
...
//        query.put();
    ...
    public Result<AppAchievement> saveFile(@RequestBody AppAchievement file) {
        Result<AppAchievement> result = new Result<>();
        try {
    ...
    public Result<AppAchievement> submitFile(@RequestBody AppAchievement file) {
        Result<AppAchievement> result = new Result<>();


        AppAchievement old = fileService.getById(file.getId());
...
//            }
    ...
    public Result<AppAchievement> batchSubmit(@RequestParam(name = "ids", required = true) String ids) {
        Result<AppAchievement> result = new Result<>();
        ...
        try {
            ...
            for (int i = 0; i < agreeIds.size(); i++) {
                AppAchievement old = fileService.getById(agreeIds.get(i));
                if (!sysUser.getUsername().equals(old.getCreateBy())){
                    return result.error500("权限不足");
                }
    ...
    public Result<AppAchievement> editFile(@RequestBody AppAchievement file) {
        Result<AppAchievement> result = new Result<>();
        AppAchievement old = fileService.getById(file.getId());
    ...
    public Result<AppAchievement> pass(@RequestBody AppAchievement entity) {
        Result<AppAchievement> result = new Result<>();


        AppAchievement old = fileService.getById(entity.getId());
    ...
    public Result<AppAchievement> refuse(@RequestBody AppAchievement entity) {
        Result<AppAchievement> result = new Result<>();
...
//            }
    ...
    public Result<String> exportXls(@RequestParam(name="customizeCells") String customizeCells,
        ...
        List<AppAchievement> pageList = new ArrayList<>();
...
//        List<FileVo> vos = fileService.transVo(pageList);
        try {
            ...
            ExcelUtil<AppAchievement> util = new ExcelUtil<>(AppAchievement.class);
...
//                List<FileVo> fileVos = fileService.transVoByExcel(listob);
    ...
    public Result<AppAchievement> saveListByExcel(@RequestBody List<AppAchievement> vos) {
        Result<AppAchievement> result = new Result<>();
    ...
    public Result<AppAchievement> saveAppendixList(@RequestBody List<HonourVo> vos) {
        Result<AppAchievement> result = new Result<>();
...
//            fileService.saveAppendixList(vos);
    ...
    public Result<?> delete(@RequestParam(name = "id", required = true) String id) {
        try {
            ...
            AppAchievement file = fileService.getById(id);
