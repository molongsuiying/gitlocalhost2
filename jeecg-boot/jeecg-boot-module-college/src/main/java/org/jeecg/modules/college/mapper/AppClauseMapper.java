 ...
 * @since 2018-12-21
 */
public interface AppClauseMapper extends BaseMapper<AppClause> {
	/**
	   * 通过父菜单ID查询子菜单
	 * @param parentId
	 * @return
	...
	public List<AppClause> queryAppClauseList();

	public List<AppClause> queryThreeList();

	int countList(Map<String,Object> params);

	int countListThree(Map<String,Object> params);
