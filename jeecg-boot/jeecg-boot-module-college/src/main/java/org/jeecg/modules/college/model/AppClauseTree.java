...
public class AppClauseTree implements Serializable {
	...
	public AppClauseTree() {
	}

	public AppClauseTree(AppClause permission) {
		...
		if (!permission.isLeaf()) {
			this.children = new ArrayList<AppClauseTree>();
		}
	...
	private List<AppClauseTree> children;
	...
	public List<AppClauseTree> getChildren() {
		return children;
	}

	public void setChildren(List<AppClauseTree> children) {
