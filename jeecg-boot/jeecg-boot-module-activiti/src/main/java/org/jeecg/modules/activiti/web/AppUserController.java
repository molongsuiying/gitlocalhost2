...
public class AppUserController {
	...
	@Autowired
	private AppUserPermissionService sysRolePermissionService;
	
	@Autowired
	private AppPermissionService sysPermissionService;
...
//			query.orderByAsc(SysPermission::getSortNo);
			List<Role> list = sysPermissionService.queryAllSys();
	...
	private void getTreeModelList(List<TreeModel> treeList, List<Role> metaList, TreeModel temp) {
		for (Role permission : metaList) {
			...
			TreeModel tree = new TreeModel(permission.getId(), permission.getRoleName());
