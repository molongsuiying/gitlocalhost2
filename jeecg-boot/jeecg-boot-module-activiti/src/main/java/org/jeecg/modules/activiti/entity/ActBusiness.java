...
public class ActBusiness {
	...
	/**状态 0草稿默认 1处理中 2结束*/
	@Excel(name = "状态 0草稿默认 1处理中 2结束 3 撤回", width = 15)
	...
	/**回访标记 0默认 1已回访*/
	@Excel(name = "回访标记 0默认 1已回访", width = 15)
	private Integer visitFlag;

	/**complainFlag*/
	@Excel(name = "投诉人回访标记:0默认 1已回访", width = 15)
	private Integer complainFlag;

	/**投诉人回访时间*/
	@Excel(name = "投诉人回访时间", width = 20, format = "yyyy-MM-dd HH:mm:ss")
	@JsonFormat(timezone = "GMT+8",pattern = "yyyy-MM-dd HH:mm:ss")
	@DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss")
	private Date complainTime;

	/**投诉人回访说明*/
	@Excel(name = "complainRemark", width = 15)
	private String complainRemark;

	/**投诉人回访满意度*/
	@Excel(name = "complainRank", width = 15)
...
/**是否发送邮件通知*/
	...
	/**自定义配置选择部门*/
	@TableField(exist=false)
	@ApiModelProperty(value = "自定义配置选择部门")
	private String departIds;

	/**是否重新申请*/
	@TableField(exist=false)
	@ApiModelProperty(value = "是否重新申请")
