package org.jeecg.modules.activiti.model;
...
public class TreeModel implements Serializable {
	...
	public TreeModel(AppPermission permission) {
	...
	public TreeModel(Role permission) {
		this.key = permission.getId();
		this.title = permission.getRoleName();
		this.slotTitle =  permission.getRoleName();
		this.value = permission.getId();
//		if(!permission.isLeaf()) {
//			this.children = new ArrayList<TreeModel>();
//		}
	}
	public TreeModel(AppSystem permission) {
		this.key = permission.getId();
		this.parentId = permission.getParentId();
		this.title = permission.getName();
		this.slotTitle =  permission.getName();
	...
	public TreeModel(String key,String slotTitle) {
		this.key = key;
		this.slotTitle =  slotTitle;
		Map<String,String> map = new HashMap<String,String>();
		map.put("title", "hasDatarule");
