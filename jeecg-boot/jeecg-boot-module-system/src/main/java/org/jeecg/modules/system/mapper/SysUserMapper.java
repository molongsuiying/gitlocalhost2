...
public interface SysUserMapper extends BaseMapper<SysUser> {
	...
	IPage<SysUser> getUserByRoleIdsAndDepartIds(Page page, @Param("roleIds") List<String> roleIds, @Param("departIds") List<String> departIds,
												@Param("userNames") List<String> userNames,@Param("username") String username);
	 ...
	 * @return
	 */
	List<SysUserRoleNameVo> getRoleNamesByUserIds(@Param("userIds")List<String> userIds);
