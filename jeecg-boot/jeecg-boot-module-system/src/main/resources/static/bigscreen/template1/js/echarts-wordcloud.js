 ...
 * @param {Object} [props.style] Extended default style org.jeecg.config
 * @param {Object} [props.shape] Extended default shape org.jeecg.config
 */
...
/**
 * config默认配置项
 * @exports zrender/org.jeecg.config
...
/**
 * 动画主控制器
 * @org.jeecg.config target 动画对象，可以是数组，如果是数组的话会批量分发onframe等事件
 * @org.jeecg.config life(1000) 动画时长
 * @org.jeecg.config delay(0) 动画延迟时间
 * @org.jeecg.config loop(true)
 * @org.jeecg.config gap(0) 循环的间隔时间
 * @org.jeecg.config onframe
 * @org.jeecg.config easing(optional)
 * @org.jeecg.config ondestroy(optional)
 * @org.jeecg.config onrestart(optional)
 *
 * TODO pause
 */
