...
public interface CommonConstant {
    ...
    */
    ...
    /**阅读状态（0未接收，1未读 2已读）*/
    public static final String MSG_NO_RECEIVE_FLAG  = "0";
    public static final String MSG_NO_READ_FLAG  = "1";
    public static final String MSG_HAS_READ_FLAG  = "2";

    /**荣誉审核状态（0未提交，1审核中 2已通过  -1 已驳回）*/
    public static final Integer HONOUR_NO_SUBMIT = 0;
    public static final Integer HONOUR_EXAMINE_ING = 1;
    public static final Integer HONOUR_SUCCESS = 2;
    public static final Integer HONOUR_REJECT = -1;

    /**
     * 文件类
     */
    public static final Integer HONOUR_CLASS_FILE = 1;
    /**
     * 证书类
     */
    public static final Integer HONOUR_CLASS_CATE = 2;
    /**
     * 物图类
     */
    public static final Integer HONOUR_CLASS_ARTICLE = 3;
    /**
     * 报道类
     */
    public static final Integer HONOUR_CLASS_REPORT = 4;
    /**
     * 协议类
     */
    public static final Integer HONOUR_CLASS_AGREE = 5;
    /**
     * 人才类
     */
    public static final Integer HONOUR_CLASS_PERSON = 6;
    /**
     * 课题类
     */
    public static final Integer HONOUR_CLASS_PROJECT = 7;

    /**
     * 汇总
     */
    public static final Integer HONOUR_CLASS_ALL = 8;
}
