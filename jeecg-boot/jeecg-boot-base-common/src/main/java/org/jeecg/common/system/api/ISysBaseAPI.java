...
public interface ISysBaseAPI {
	...
	String addAppendix(String fileName,String fileType,String fileSize,String fileUrl);

	long countLoginNum();

	void saveDepartByCollege(String collegeName);

	void deleteDepartByCollegeName(String collegeName);

	Map<String,Object> getQueryMap(Map<String,Object> query);
