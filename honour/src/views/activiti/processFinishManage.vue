    ...
    <a-card>
      ...
      <a-row>
        ...
        >
          ...
          <a-table-column title="原因详情" dataIndex="deleteReason"  align="center">
            <template slot-scope="t,r,i" >
          ...
          <a-table-column title="开始时间" dataIndex="startTime" :width="160" align="center">
            <template slot-scope="t,r,i" >
              <span > {{t}} </span>
            </template>
          </a-table-column>
          <a-table-column title="结束时间" dataIndex="endTime" :width="160" align="center">
            <template slot-scope="t,r,i" >
              <span > {{t}} </span>
            </template>
          </a-table-column>
          <a-table-column title="操作" dataIndex="" :width="180" fixed="right">
            <template slot-scope="t,r,i" >
              <a href="javascript:void(0);" style="color: green;" @click="history(r)" >流程历史</a>
