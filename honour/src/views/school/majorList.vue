<template>
  <a-card :bordered="false">
            ...
            <a-row :gutter="10">
              <a-col :md="8" :sm="12">
                <a-form-item label="名称">
                  <a-input style="width: 120px;" placeholder="专业名称" v-model="queryParam.majorName"></a-input>
                </a-form-item>
              </a-col>
              <a-col :md="9" :sm="24">
    ...
    <major-modal ref="modalForm" @ok="modalFormOk"></major-modal> <!-- 字典数据 -->
  </a-card>
</template>
...
<script>
  ...
  import MajorModal from "./modules/MajorModal"
  ...
  export default {
    ...
    methods: {
      ...
      // 添加字典数据
      handleAdd() {
        this.$refs.modalForm.add(this.departmentId)
        this.$refs.modalForm.title = "新增专业"
      },
      showDrawer() {
        this.visible = true
      },
      ...
      gotoBunch(record) {
         console.log(record)
         var params = {
           ids: record.collegeId + "-" + record.departmentId + "-" + record.id
         }
         this.$router.push({ path: "/school/studentList", query: params })
      },
      // 抽屉的宽度随着屏幕大小来改变
      resetScreenSize() {
