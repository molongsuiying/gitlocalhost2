<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="24">
            <a-form-item :label="compLabel">
              ...
              <jeecg-select fields="title" tableId="3" v-model="queryParam.title" placeholder="请输入标题"></jeecg-select>
            </a-form-item>
          </a-col>
    ...
    <!-- table区域-end -->
    <honour-article-modal ref="modalForm" @ok="modalFormOk"></honour-article-modal>
    <imag-preview ref="imgPerview" @ok="modalFormOk"></imag-preview>
    <query-article-list-modal ref="queryList" @close="queryClose"></query-article-list-modal>
    <article-excel-modal ref="articleExcelModal" @ok="modalFormOk"></article-excel-modal>
  </a-card>
</template>
...
<script>
  ...
  import Vue from 'vue'
  import HonourArticleModal from '../modules/HonourArticleModal'
  import ImagPreview from '../modules/ImagPreview'
  import QueryArticleListModal from './QueryArticleListModal'
  import {
    JeecgListMixin
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: '/honour/article/queryHonourArticleList',
          batchSubmit: '/honour/article/batchSubmit',
          submit: '/honour/article/submitArticle',
          exportXls: '/honour/article/exportXls',
    ...
    methods: {
      ...
      loadData(arg) {
        ...
        getAction(this.url.list, params).then((res) => {
          if (res.success && res.result) {
            ...
            this.$emit('articleFn', articleNum)
          }
        })
      },
      downloadAppendix(record) {
        record.honourClass = 3
      ...
      handlePass(record) {
        ...
        this.$refs.modalForm.title = '审核物图类荣誉'
