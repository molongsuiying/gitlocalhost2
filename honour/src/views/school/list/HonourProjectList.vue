<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="24">
            <a-form-item :label="compLabel">
              ...
              <jeecg-select fields="title" tableId="7" v-model="queryParam.title" placeholder="请输入标题"></jeecg-select>
            </a-form-item>
          </a-col>
          ...
          <a-col :md="6" :sm="24">
            <a-form-item label="学生姓名">
              ...
              <jeecg-select fields="student_name" tableId="7" v-model="queryParam.studentName" placeholder="请输入学生姓名"></jeecg-select>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="24">
            <a-form-item label="教师姓名">
              <!-- <a-input placeholder="请输入教师姓名" v-model="queryParam.teacherName"></a-input> -->
              <jeecg-select fields="teacher_name" tableId="7" v-model="queryParam.teacherName" placeholder="请输入教师姓名"></jeecg-select>
            </a-form-item>
          </a-col>

          <a-col :md="6" :sm="24">
            <a-form-item label="立项负责人">
              <jeecg-select fields="build_project_charge" tableId="7" v-model="queryParam.buildProjectCharge" placeholder="请输入立项负责人"></jeecg-select>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="24">
            <a-form-item label="结项负责人">
              <jeecg-select fields="over_project_charge" tableId="7" v-model="queryParam.overProjectCharge" placeholder="请输入结项负责人"></jeecg-select>
            </a-form-item>
          </a-col>
    ...
    <query-project-list-modal ref="queryList" @close="queryClose"></query-project-list-modal>
    <project-excel-modal ref="projectExcelModal" @ok="modalFormOk"></project-excel-modal>
  </a-card>
</template>
...
<script>
  ...
  import Vue from 'vue'
  import HonourProjectModal from '../modules/HonourProjectModal'
  import ProjectExcelModal from '../excel/projectExcelModal'
  import ImagPreview from '../modules/ImagPreview'
  import QueryProjectListModal from './QueryProjectListModal'
  import {
    JeecgListMixin
    ...
    data() {
      return {
        ...
        url: {
          ...
          batchSubmit: '/honour/project/batchSubmit',
