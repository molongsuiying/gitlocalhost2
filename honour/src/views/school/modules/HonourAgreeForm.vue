<template>
  ...
  <a-form :form="form">
    ...
    <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="合作类别">
      <a-radio-group v-decorator="['cooperationType', validatorRules.cooperationType]" @change="onChange">
    ...
    <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="合作类别(其他)" v-show="txtFlag">
      <a-input placeholder="请输入合作类别(其他)" v-decorator="['cooperationTypeTxt',{}]" />

    </a-form-item>

    <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="合作单位">
      <a-input placeholder="请输入合作单位" v-decorator="['cooperationUnit', validatorRules.cooperationUnit]" />
    </a-form-item>
