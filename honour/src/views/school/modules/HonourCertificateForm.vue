<template>
  ...
  <a-form :form="form">
    ...
    <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="证书类别">
      <a-radio-group v-decorator="['prizeType', validatorRules.prizeType]" @change="onChange">
        <a-radio :value="'1'">
          奖励
        </a-radio>
        <a-radio :value="'99'">
    ...
    <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="指导教师" v-if="selectName == 'studentName' && prizeType == 1">
    ...
    <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="证书类别(其他)" v-show="prizeType == 99">
      <a-input placeholder="请输入证书类别(其他)" v-decorator="['otherName',{}]" />
    </a-form-item>
