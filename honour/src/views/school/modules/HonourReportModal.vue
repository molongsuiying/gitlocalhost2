    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          label="媒体类别"
        >
          <a-radio-group :disabled="examineFlag" v-decorator="['mediumType', validatorRules.mediumType]" @change="onMediumChange">
        ...
        <a-form-item
          ...
          v-show="mediumFlag"
        >
          <a-input placeholder="请输入媒体类别(其他)" v-decorator="['mediumTypeTxt',{}]" :disabled="examineFlag"/>
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="媒体名称">
          <a-input placeholder="请输入媒体名称" v-decorator="['mediumName', validatorRules.mediumName]" :disabled="examineFlag"/>
        </a-form-item>
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="作者署名">
          <a-input placeholder="请输入作者署名" v-decorator="['author', validatorRules.author]" :disabled="examineFlag"/>
        </a-form-item>
        ...
        <a-form-item
          ...
          label="成果类别"
        >
          <a-radio-group :disabled="examineFlag" v-decorator="['achievementType', validatorRules.achievementType]" @change="onAchievementChange">
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        ...
        validatorRules: {
          ...
          mediumType: { rules: [{ required: true, message: '请输入媒体类别' }] },
          mediumName: { rules: [{ required: true, message: '请输入媒体名称' }] },
          author: { rules: [{ required: true, message: '请输入作者署名' }] },
        ...
        url: {
          ...
          pass: '/honour/report/passReport',
          refuse: '/honour/report/refuseReport'
        }
      }
    },
    created() {
    ...
    methods: {
      ...
      findLikeTitleList() {
        this.$refs.titleModal.add(this.model, 5)
