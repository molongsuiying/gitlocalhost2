<template>
  ...
  <a-form :form="form">
    ...
    <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="物图类别">
    ...
    <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="物图类别(其他)" v-show="articleFlag">
    ...
    <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="开展部门">
    ...
    <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="开展部门(其他)" v-show="authorityFlag">
