    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          label="物图类别"
        >
          <a-radio-group :disabled="examineFlag" v-decorator="['articleType', validatorRules.articleType]" @change="onArticleChange">
        ...
        <a-form-item
          ...
          v-show="articleFlag"
        >
          <a-input placeholder="请输入物图类别(其他)" v-decorator="['articleTypeTxt',{}]" :disabled="examineFlag"/>
        ...
        >
          <a-input placeholder="请输入开展部门(其他)" v-decorator="['authorityTxt',{}]" :disabled="examineFlag"/>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          ...
          pass: '/honour/article/pass',
          refuse: '/honour/article/refuse'
        }
      }
    },
    created() {
    ...
    methods: {
      ...
      findLikeTitleList() {
        this.$refs.titleModal.add(this.model, 3)
