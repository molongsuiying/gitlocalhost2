  ...
  <a-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="课题类型">
        ...
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="指导教师" v-if="selectName == 'studentName'">
          <a-input placeholder="请输入指导教师" v-decorator="['teacherName',{}]" />
        </a-form-item>

        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="立项负责人">
          <a-input placeholder="请输入立项负责人" v-decorator="['buildProjectCharge',{}]" />
        </a-form-item>

        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="结项负责人">
          <a-input placeholder="请输入结项负责人" v-decorator="['overProjectCharge',{}]" />
        </a-form-item>
        ...
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="颁发机关">
          <a-radio-group :disabled="examineFlag" v-decorator="['authorityType', validatorRules.authorityType]" @change="onAuthorityChange">
        ...
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="成果级别">
          <a-radio-group :disabled="examineFlag" v-decorator="['achievementLevel', validatorRules.achievementLevel]" @change="onLevelChange">
        ...
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="归属专业">
          <!-- <jtree-select-major v-model="model.majorId" placeholder="请选择归属专业" dictCode="zd_major,major_name,id,1=1 order by major_code" :disabled="examineFlag"></jtree-select-major> -->
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          add: '/honour/project/saveProject',
          edit: '/honour/project/editProject',
          submit: '/honour/project/submitProject',
          getAppendix: '/honour/findAppendixByIds',
          pass: '/honour/project/pass',
          refuse: '/honour/project/refuse'
        }
      }
    },
    created() {
    ...
    methods: {
      ...
      findLikeTitleList() {
        this.$refs.titleModal.add(this.model, 7)
      ...
      handleOk() {
        ...
        this.form.validateFields((err, values) => {
          if (!err) {
            ...
            if (this.selectName == 'teacherName') {
              values.studentName = ''
            }
