    ...
    <a-spin :spinning="confirmLoading">
      ...
      <a-table
        ...
        <template slot="prizeType" slot-scope="text,record">
          ...
          <template v-else-if="record.departmentName != ''">
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          importExcelUrl: '/honour/certificate/importExcel',
          saveListByExcel: '/honour/certificate/saveListByExcel'
        }
      }
    },
    created() {
    ...
    methods: {
      ...
      exportXlsTemp() {
        var url = getFileAccessHttpUrl('excel/temp/证书类荣誉模板.xlsx')
        var fileName = '证书类荣誉模板'
