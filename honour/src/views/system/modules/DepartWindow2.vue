    ...
    methods: {
      ...
      onCheck(checkedKeys, info) {
        ...
        if (checkedKeys.checked.length > 1) {
          var item = checkedKeys.checked[checkedKeys.checked.length - 1]
          checkedKeys.checked = []
          checkedKeys.checked.push(item)
          var item2 = info.checkedNodes[info.checkedNodes.length - 1]
          info.checkedNodes = []
          info.checkedNodes.push(item2)
        }
        this.departList = []
