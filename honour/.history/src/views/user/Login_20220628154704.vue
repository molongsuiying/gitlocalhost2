  ...
  export default {
    ...
    created () {
      ...
      // update-end- --- author:scott ------ date:20190805 ---- for:密码加密逻辑暂时注释掉，有点问题
          // fetch("http://localhost:8084/jeecg-boot/app/select").then((response)=>{
    ...
    methods: {
      ...
      // getid(){
      //       console.log(this.$refs.text.value,1111)
      // },
      // 第三方登录
      onThirdLogin(source) {
      ...
      loginSuccess () {
        ...
        this.iframUrl = `${window._CONFIG['domianURL']}${this.url.select}?name=${this.createObj.name||""}&key=${this.createObj.key||""}&description=${this.createObj.description||""}`
