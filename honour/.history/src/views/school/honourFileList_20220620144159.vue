        ...
        <div>
          ...
          <a-table
            ...
            <span slot="action" slot-scope="text, record">
              ...
              <a v-has="'user:honourEdit'" @click="handleEdit(record)" v-show="record.status!=1 && record.status!=2 &&record.status!=3">编辑</a>
...
<script>
  ...
  import Vue from 'vue'
  import HonourCertificate from './modules/HonourCertificate'
  import HonourReport from './modules/HonourReport'
  import HonourAgree from './modules/HonourAgree'
  import HonourArticle from './modules/HonourArticle'
  import HonourPerson from './modules/HonourPerson'
  import HonourProject from './modules/HonourProject'
