<template>
  <a-form :form="form">
    ...
    <a-form-item
      ...
      label="标题">
      <a-input :disabled="disabled" placeholder="请输入标题" v-decorator="['title', validatorRules.title]"/>
    </a-form-item>
    ...
    <a-form-item
      ...
      :wrapperCol="wrapperCol"
      label="负责人">
      <a-input :disabled="disabled" placeholder="请输入负责人" v-decorator="['leader', {}]"/>
    </a-form-item>

    <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="作品名称">
      <a-input :disabled="disabled" placeholder="请输入作品名称" v-decorator="['workName', validatorRules.workName]" />
    </a-form-item>
    ...
    <a-form-item
      ...
      :wrapperCol="wrapperCol"
      label="发文字号">
      <a-input :disabled="disabled" placeholder="请输入发文字号" v-decorator="['articleNum', validatorRules.articleNum]"/>
    </a-form-item>
    ...
    <a-form-item
      ...
      label="发文机关"
    >
      <a-radio-group :disabled="disabled" v-decorator="['authorityType', validatorRules.authorityType]" @change="onAuthorityChange">
    ...
    >
      <a-input :disabled="disabled" placeholder="请输入发文机关(其他)" v-decorator="['authorityTxt',{}]"/>

    </a-form-item>

    <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="荣誉等级">
      <a-radio-group :disabled="disabled" v-decorator="['honourLevel', {}]">
    ...
    <a-form-item
      ...
      label="成果类别"
    >
      <a-radio-group :disabled="disabled" v-decorator="['achievementType', validatorRules.achievementType]" @change="onAchievementChange">
    ...
    >
      <a-input :disabled="disabled" placeholder="请输入成果类别(其他)" v-decorator="['achievementTypeTxt',{}]"/>
    ...
    <a-form-item
      ...
      label="成果级别"
    >
      <a-radio-group :disabled="disabled" v-decorator="['achievementLevel', validatorRules.achievementLevel]" @change="onLevelChange">
    ...
    <a-form-item
      ...
      v-show="levelFlag"
    >
      <a-input :disabled="disabled" placeholder="请输入成果级别(其他)" v-decorator="['achievementLevelTxt',{}]"/>

    </a-form-item>

    <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="团队成员">
      <a-select :disabled="disabled" mode="tags" placeholder="请输入团队成员姓名" v-model="teamPersons" @change="saveTeamsPerson">
      </a-select>
    ...
    <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="归属专业">
      ...
      <j-select-depart :disabled="disabled" v-model="model.majorId" :trigger-change="true" customReturnField="id"></j-select-depart>
    </a-form-item>

    <a-form-item label="附件" :labelCol="labelCol" :wrapperCol="wrapperCol">
      <j-image-upload :disabled="disabled" class="avatar-uploader" text="上传" v-model="fileList"></j-image-upload>
    </a-form-item>
