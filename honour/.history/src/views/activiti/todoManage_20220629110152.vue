          ...
          <a-table-column title="操作" dataIndex="" align="center">
            <template slot-scope="t,r,i">
              <template v-if="r.startUnite != 1">
                ...
                <span v-else>
                  <a @click="handlePass(record)" style="color: blue">查看并处理</a>
                  <a-divider type="vertical" />
                  <a @click="handlePass()" v-has="'user:examine'">审核</a>
                  <a-divider type="vertical" v-has="'user:examine'"/>
              ...
              <template v-else>
                ...
                <span v-else>
                  <a href="javascript:void(0);" @click="handlePass(record)" style="color: blue">查看并处理</a>
                  <a-divider type="vertical" />
                </span>
                <a @click="handlePass()" v-has="'user:examine'">审核</a>
                  <a-divider type="vertical" v-has="'user:examine'"/>
