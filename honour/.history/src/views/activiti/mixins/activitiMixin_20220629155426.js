...
/*        {
        ...
        }, */
        {
          ...
          component:() => import(`@/views/activiti/form/complain`),
          businessTable:'act_z_complain'
        },
        {
          text:'申报表单',
          routeName:'@/views/school/modules/HonourFileForm',
          component:() => import(`@/views/school/modules/HonourFileForm`),
          businessTable:'zd_honour_file'
        },
        {
          routeName:'@/views/school/modules/HonourDetailModal',
          component:() => import(`@/views/school/modules/HonourDetailModal`),
        },
        {
          routeName:'@/views/school/modules/HonourFileModal',
          component:() => import(`@/views/school/modules/HonourFileModal`),
        }
      ]
    },
  ...
  methods:{
    getFormComponent(routeName){
      var curr;
      for(var i= 0;i<this.allFormComponent.length;i++){
        if(this.allFormComponent[i].routeName == routeName){
           curr = this.allFormComponent[i];
        }
      } 
       return curr;
